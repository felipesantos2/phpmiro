...
O projeto pode ser executado rapidamente com o `docker`. Só é necessário ter o docker instalado em sua maquina. O PHP, Composer e tudo mais ele vai organizar para você.
